    ...
    <div class="row flex justify-content-center">
        <div class="col-8">
            ...
            <div class="book-content">
                ...
                <form class="form-horizontal" action="action/regis.php" method="post"> 
                    <div class="form-group row">
                          <div class="col-10">
                            <label for="Nama" class="col-12">Masukkan ID </label>
                  ...
                  <form id="formBooking" action="input.php" method="post" >
                        <br><br><br><br><br>
                        <div class="col-6">
                            <label for="nama" class="col-12">Nama </label>
    ...
    <div class="col-md-6">
        ...
        <div class="col-md-12">
          ...
          <input type="text" name="lainnya" class="form-control" placeholder="Perbaikan Lainnya">
                    ...
                    <div class="button">
                        <button class="btn btn-primary btn-lg" name="inputdata" ">Submit</button>
                    </div>
                </form>
            </div>
        </div>
          ...
          <div class="mvp-main-box">
            ...
            <div id="mvp-foot-menu-wrap" class="left relative">
              <div id="mvp-foot-menu" class="left relative">
                <div class="menu-footer-menu-new-container"><ul id="menu-footer-menu-new" class="menu"><li id="menu-item-30646" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-30646"><a href="page/bookingservice.php">Booking Service</a></li>
<li id="menu-item-30647" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-30647"><a href="page/tracking.php">Tracking</a></li>
<li id="menu-item-30648" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-30648"><a href="page/perawatan.php">Perawatan</a></li>
