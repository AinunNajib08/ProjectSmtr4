...
class Siswa extends CI_Controller {
    ...
    public function index(){
        ...
        $this->load->view("siswa/_partials/head");
        $this->load->view("siswa/_partials/sidebar");
        $this->load->view("siswa/_partials/nav.php");
        $this->load->view('siswa/_partials/index', $data);
        $this->load->view("siswa/_partials/footer");
        $this->load->view("siswa/_partials/js");
    }
    ...
    public function ubah($nis){
        if($this->input->post('ubah')){ // Jika user mengklik tombol submit yang ada di form
