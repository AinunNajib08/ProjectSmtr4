                            ...
                            <form class="needs-validation" novalidate>
                                <div class="row">
                                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 ">
                                        ...
                                        <input type="text" class="form-control" placeholder="First name" name="input_nis" value="<?php echo set_value('input_nis', $siswa->nis); ?>" required>
                                    ...
                                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 ">
                                        ...
                                        <input type="text" class="form-control" placeholder="Last name" name="input_nama" value="<?php echo set_value('input_nama', $siswa->nama);?>" required>
                                        <div class="valid-feedback">
                                            Looks good!
                                        </div>
                                    </div>
                                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 ">
                                        <label for="validationCustom02">JenisKelamin</label>
                                        <input type="text" class="form-control"  placeholder="Last name" name="input_jeniskelamin" value="<?php echo set_value('input_jeniskelamin', $siswa->jenis_kelamin);?>" required>
                                        <div class="valid-feedback">
                                            Looks good!
                                        </div>
                                    </div>
                                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 ">
                                        <label for="validationCustom02">Telp</label>
                                        <input type="text" class="form-control"  placeholder="Last name" name="input_telp" value="<?php echo set_value('input_telp', $siswa->telp); ?>" required>
                                        <div class="valid-feedback">
                                            Looks good!
                                        </div>
                                    </div>
                                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 ">
                                        ...
                                        <textarea type="text" class="form-control"  placeholder="Last name" name="input_alamat" required><?php echo set_value('input_alamat', $siswa->alamat); ?></textarea>
                                        <div class="valid-feedback">
                                            Looks good!
                                        </div>
                                    </div>
                                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 ">
                                        <br>
                                        <input type="submit" class="btn btn-space btn-primary" name="ubah">
