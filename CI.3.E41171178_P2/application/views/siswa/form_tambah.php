...
John Abraham</span>is now following you
    ...
    <div class="dashboard-wrapper">
        <div class="container-fluid  dashboard-content">
            ...
            <?php echo form_open("index.php/siswa/tambah"); ?>
            <div class="row">
                <!-- ============================================================== -->
                <!-- validation form -->
                <!-- ============================================================== -->
                            ...
                            <form class="needs-validation" novalidate>
                                <div class="row">
                                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 ">
                                        ...
                                        <input type="text" class="form-control" placeholder="First name" name="input_nis" value="<?php echo set_value('input_nis'); ?>" required>
                                    ...
                                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 ">
                                        ...
                                        <input type="text" class="form-control" placeholder="Last name" name="input_nama" value="<?php echo set_value('input_nama'); ?>" required>
                                        <div class="valid-feedback">
                                            Looks good!
                                        </div>
                                    </div>
                                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 ">
                                        ...
                                        <input type="text" class="form-control"  placeholder="Last name" name="input_jeniskelamin" value="<?php echo set_value('input_jeniskelamin'); ?>" required>
                                        <div class="valid-feedback">
                                            Looks good!
                                        </div>
                                    </div>
                                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 ">
                                        ...
                                        <input type="text" class="form-control"  placeholder="Last name" name="input_telp" value="<?php echo set_value('input_telp'); ?>" required>
                                        <div class="valid-feedback">
                                            Looks good!
                                        </div>
                                    </div>
                                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 ">
                                        ...
                                        <textarea type="text" class="form-control"  placeholder="Last name" name="input_alamat" required><?php echo set_value('input_alamat'); ?></textarea>
                                        <div class="valid-feedback">
                                            Looks good!
                                        </div>
                                    </div>
