...
<html lang="en">
  ...
  <head>
    ...
    <link href="<?php echo base_url('siswa/vendor/datatables/dataTables.bootstrap4.css');?>" rel="stylesheet">
  ...
  <body id="page-top">
    ...
    <script src="<?php echo base_url('siswa/vendor/chart.js/Chart.min.js');?>"></script>
    <script src="<?php echo base_url('siswa/vendor/datatables/jquery.dataTables.js');?>"></script>
    <script src="<?php echo base_url('siswa/vendor/datatables/dataTables.bootstrap4.js');?>"></script>

    <!-- Custom scripts for all pages-->
    <script src="<?php echo base_url('siswa/js/sb-siswa.min.js');?>"></script>

    <!-- Demo scripts for this page-->
    <script src="<?php echo base_url('siswa/js/demo/datatables-demo.js');?>"></script>
    <script src="<?php echo base_url('siswa/js/demo/chart-area-demo.js');?>"></script>
